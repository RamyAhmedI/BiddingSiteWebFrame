 ...
 */
class getShippingDetailsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ShippingDetailsRepository' shared autowired service.
     *
     * @return \App\Repository\ShippingDetailsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ShippingDetailsRepository.php';

        return $container->privates['App\\Repository\\ShippingDetailsRepository'] = new \App\Repository\ShippingDetailsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
