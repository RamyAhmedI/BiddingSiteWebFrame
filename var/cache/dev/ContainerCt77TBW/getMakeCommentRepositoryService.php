 ...
 */
class getMakeCommentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MakeCommentRepository' shared autowired service.
     *
     * @return \App\Repository\MakeCommentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MakeCommentRepository.php';

        return $container->privates['App\\Repository\\MakeCommentRepository'] = new \App\Repository\MakeCommentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
